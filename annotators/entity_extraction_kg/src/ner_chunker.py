    ...
    def __call__(self, text_raw_batch: List[str],
        ...
        for text_batch, sentences_offsets_batch, sentences_batch in \
            ...
            if self.ner_parser:
                ...
                ner_tokens_batch, ner_tags_batch, ner_tokens_offsets_batch, entity_substr_batch, \
                    entity_positions_batch, entity_tags_batch, entity_probas_batch = self.ner(text_batch)
                entity_pos_tags_probas_batch = \
                    [list(zip(entity_substr_list, entity_positions_list, entity_tags_list, entity_probas_list))
                     for entity_substr_list, entity_positions_list, entity_tags_list, entity_probas_list,
                     in zip(entity_substr_batch, entity_positions_batch, entity_tags_batch, entity_probas_batch)] 
