...
- Jenkins Tests Status on dev branch: [![Build Status](http://lnsigo.***REMOVED***.ru:8080/buildStatus/icon?job=assistant%2Fdev)](http://lnsigo.***REMOVED***.ru:8080/job/dp-multibranch/job/dev/)
